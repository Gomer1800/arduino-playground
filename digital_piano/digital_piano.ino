/*
 * Essentially a keeyboard incorporating notes around middle C. This outputs the played
 * note to an LCD crystal display. UI is provided via the serial monitor
 * 
 * Luis Gomez 2015
 */
