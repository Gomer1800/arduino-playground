/* This program reads from an analog pin and outputs a scaled value determined by (potentiometer)
 *  to another analog pin.
 *  Also diplays information on serial monitor
 *  
 *  Luis Gomez
 */
