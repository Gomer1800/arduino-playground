/* LED lightshow: Offers 3 different light shows using a preset configuration of LEDs.
 * This eventualy evolved into the LED lightshow/jukebox, pictures found in that directory
 * 2/9/15
